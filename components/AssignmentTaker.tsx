...
export default function AssignmentTaker({
  ...
  const isSubmitted = existingSubmission && existingSubmission.assignmentState && existingSubmission.assignmentState.fileUrl;
  const submissionUrl = isSubmitted ? existingSubmission.assignmentState.fileUrl : null;
